...
@Component({
  selector: 'app-details-admin-cosmetic-product',
  templateUrl: './details-admin-cosmetic-product.component.html',
  styleUrls: ['./details-admin-cosmetic-product.component.css']
})
export class DetailsAdminCosmeticProductComponent implements OnInit {
