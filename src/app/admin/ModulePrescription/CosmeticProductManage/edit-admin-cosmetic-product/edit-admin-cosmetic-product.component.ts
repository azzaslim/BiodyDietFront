...
@Component({
  selector: 'app-edit-admin-cosmetic-product',
  templateUrl: './edit-admin-cosmetic-product.component.html',
  styleUrls: ['./edit-admin-cosmetic-product.component.css']
})
export class EditAdminCosmeticProductComponent implements OnInit {
