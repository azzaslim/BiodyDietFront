...
import { ADD_PRODUCT_URL, DELETE_PRODUCT_URL, GETALL_COMPLEMENTS_URL, GETALL_preparations_URL, GETALL_PREPARATION_URL, GETALL_PRODUCTS_URL, GETALL_SUPPLIMENTS_URL, GET_ONE_PRODUCT_URL, UPDATE_PRODUCT_URL } from 'src/common/url';
