...
@Component({
  selector: 'app-add-user-complement',
  templateUrl: './add-user-complement.component.html',
  styleUrls: ['./add-user-complement.component.css']
})
export class AddUserComplementComponent implements OnInit {
    ...
    this.AddNewProduct.controls.symptoms.patchValue(this.SelectedSymptoms);
      ...
      successNotification() {
        Swal.fire({
          position: 'center',
          icon: 'success',
          title: 'Complement ajouté avec succées',
