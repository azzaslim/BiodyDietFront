...
@Component({
  selector: 'app-add-cosmetic-product',
  templateUrl: './add-cosmetic-product.component.html',
  styleUrls: ['./add-cosmetic-product.component.css']
})
export class AddCosmeticProductComponent implements OnInit {
    ...
    this.AddNewProduct.controls.symptoms.patchValue(this.SelectedSymptoms);
      ...
      successNotification() {
        Swal.fire({
          position: 'center',
          icon: 'success',
          title: 'Produit ajouté avec succées',
