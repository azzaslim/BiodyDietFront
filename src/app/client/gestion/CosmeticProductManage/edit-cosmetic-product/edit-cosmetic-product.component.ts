...
@Component({
  selector: 'app-edit-cosmetic-product',
  templateUrl: './edit-cosmetic-product.component.html',
  styleUrls: ['./edit-cosmetic-product.component.css']
})
export class EditCosmeticProductComponent implements OnInit {
